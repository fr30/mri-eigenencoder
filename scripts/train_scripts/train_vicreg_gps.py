...
from src.model import VicREGGPS
...
@hydra.main(version_base=None, config_path="configs", config_name="vicreg_gps")
def main(cfg):
    ...
    criterion = VicregLoss(
        num_features=model.out_dim,
        batch_size=cfg.train.batch_size,
        sim_coeff=cfg.train.sim_coeff,
        std_coeff=cfg.train.std_coeff,
        cov_coeff=cfg.train.cov_coeff,
    )
