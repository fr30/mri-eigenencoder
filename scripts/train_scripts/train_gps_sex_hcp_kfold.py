...
from src.dataset import HCPfMRIDataset, GPSConcatDataset
...
@hydra.main(version_base=None, config_path="configs", config_name="gps_sex_hcp")
def main(cfg):
    ...
    labels = hcp_dataset.labels

    dataset = GPSConcatDataset([hcp_dataset])
    kf = StratifiedKFold(
        n_splits=5,
        shuffle=True,
