...
from src.dataset import COBREfMRIDataset, GPSConcatDataset
...
@hydra.main(version_base=None, config_path="configs", config_name="gps_cobre")
def main(cfg):
    ...
    labels = cobre_dataset.labels

    dataset = GPSConcatDataset([cobre_dataset])
    kf = StratifiedKFold(
        n_splits=5,
        shuffle=True,
