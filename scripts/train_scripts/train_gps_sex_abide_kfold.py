...
@hydra.main(version_base=None, config_path="configs", config_name="gps_sex_abide")
def main(cfg):
    ...
    abide_dataset = ABIDEfMRIDataset(split="full", label="sex")
    ...
    splits = kf.split(dataset, abide_dataset.labels)
    run_train_accs = []
    run_val_accs = []
    run_train_losses = []
    run_val_losses = []
